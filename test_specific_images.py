...
def test_specific_images():
    ...
    for img_num in images_to_test:
        ...
        try:
            ...
            # Détection de grille
            print(f"  3️⃣  Détection de grille...")
            ...
            if grid.get('valid'):
                ...
                print(f"     ✗ Grille non valide")
            
            # Regroupement par lignes
            print(f"  4️⃣  Regroupement par lignes...")
            ...
            print(f"  5️⃣  Détection de structure...")
            ...
            print(f"  6️⃣  Construction du tableau...")
            if grid.get('valid'):
